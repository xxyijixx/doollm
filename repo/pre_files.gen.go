...
func newFile(db *gorm.DB, opts ...gen.DOOption) file {
	...
	_file.Pid = field.NewInt64(tableName, "pid")
	_file.Pids = field.NewString(tableName, "pids")
	_file.Cid = field.NewInt64(tableName, "cid")
	...
	_file.Userid = field.NewInt64(tableName, "userid")
	_file.Share = field.NewInt32(tableName, "share")
	_file.Pshare = field.NewInt64(tableName, "pshare")
	_file.CreatedID = field.NewInt64(tableName, "created_id")
...
func (f *file) updateTableName(table string) *file {
	...
	f.Pids = field.NewString(table, "pids")
	f.Cid = field.NewInt64(table, "cid")
	...
	f.Share = field.NewInt32(table, "share")
	f.Pshare = field.NewInt64(table, "pshare")
	f.CreatedID = field.NewInt64(table, "created_id")
...
func (f *file) fillFieldMap() {
	...
	f.fieldMap["pids"] = f.Pids
	f.fieldMap["cid"] = f.Cid
	f.fieldMap["name"] = f.Name
	f.fieldMap["type"] = f.Type
	f.fieldMap["ext"] = f.Ext
	f.fieldMap["size"] = f.Size
	f.fieldMap["userid"] = f.Userid
	f.fieldMap["share"] = f.Share
	f.fieldMap["pshare"] = f.Pshare
	f.fieldMap["created_id"] = f.CreatedID
