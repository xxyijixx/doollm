...
const TableNameReportReceife = "pre_report_receives"

type ReportReceife struct {
	ID          int64     `gorm:"column:id;primaryKey;autoIncrement:true" json:"id"`
	Rid         int32     `gorm:"column:rid;not null" json:"rid"`
...
func (*ReportReceife) TableName() string {
	return TableNameReportReceife
}
