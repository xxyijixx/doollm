...
func (p *projectUser) WithContext(ctx context.Context) IProjectUserDo {
...
func (p projectUser) Columns(cols ...field.Expr) gen.Columns { return p.projectUserDo.Columns(cols...) }
